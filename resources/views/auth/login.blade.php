    ...
    <div>
        ...
        <div class="col col-login mx-auto mt-7">
            <div class="text-center text-white">
                <div class="" style="background-color: white; border-radius: 50%; padding: 10px; display: inline-block;">
                    @php
                    ...
                    @endphp
                    @if ($logoPath)
                        <img src="{{ asset($logoPath) }}" alt="Application Logo" width="200">
                    @else
                        <img src="{{ asset('images/logo-default.svg') }}" alt="Application Logo" width="200">
                    @endif
